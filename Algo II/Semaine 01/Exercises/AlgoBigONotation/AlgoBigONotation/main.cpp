...
void printAllEvenNumbersBetweenInclusive(int start, int end)
{
    ...
    for (int i = start; i <= end; ++i)
    {
        if (i % 2 == 0)
        {
            ligne += std::to_string(i) + separator;
        }
    }
    cout << ligne << endl;
}
...
void printQuantityOfEvenNumbersBetweenInclusiveV1(int start, int end)
{
    ...
    if (end > start)
    {
        ...
        for (int i = start; i <= end; ++i)
        {
            if (i % 2 == 0)
            {
                ligne += std::to_string(start) + separator;
            }
        }
        cout << ligne;
    }
...
void printQuantityOfEvenNumbersBetweenInclusiveV2(int start, int end)
{
    ...
    std::string ligne = "";
    std::string separator = ", ";
    int nombreCourant = start;
    if (nombreCourant >= end)
    {
        cout << ligne << endl;
    }
    else
    {
        ...
        {
            ligne += std::to_string(nombreCourant) + separator;
        }
        nombreCourant++;
        //printQuantityOfEvenNumbersBetweenInclusiveV1(nombreCourant, end);
    }
}
