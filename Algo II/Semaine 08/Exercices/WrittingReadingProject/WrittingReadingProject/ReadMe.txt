========================================================================
    APPLICATION CONSOLE : Vue d'ensemble du projet WrittingReadingProject
========================================================================

AppWizard a créé cette application WrittingReadingProject pour vous.

Ce fichier contient un résumé du contenu de chacun des fichiers qui constituent votre application WrittingReadingProject.


WrittingReadingProject.vcxproj
...
WrittingReadingProject.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Ces fichiers sont utilisés pour générer un fichier d'en-tête précompilé (PCH) WrittingReadingProject.pch et un fichier de type précompilé nommé StdAfx.obj.
