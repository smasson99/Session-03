...
namespace platformer
{
	...
	public:
		...
		bool init(const int limiteGauche, const int limiteDroite, const String texturePath, const String movePath, const bool moveLeft, const String idlePath);
	private:
		static const int TAILLE_RECT = 64;

		Texture texture;
        Texture animMoveLeftTexture;
        Texture animMoveRightTexture;
        bool flipMoveRight;
        bool flipMoveLeft;
        Texture animIdleTexture;
